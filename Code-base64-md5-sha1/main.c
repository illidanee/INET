...
int main()
{
	//base64编码解码
	int nEncodeLen;
	char* pEncodeBuffer = base64_encode("Hello World.", strlen("Hello World."), &nEncodeLen);
	printf("Encode[Base64]:%s\n", pEncodeBuffer);

	int nDecodeLen;
	char* pDecodeBuffer = base64_decode(pEncodeBuffer, nEncodeLen, &nDecodeLen);
	...
	md5("Hello World.", strlen("Hello World."), pMd5Buffer);
	...
	crypt_sha1("Hello World.", strlen("Hello World."), pSha1Buffer, &nSha1Len);
